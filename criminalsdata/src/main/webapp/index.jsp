...
Alive:<input type="radio" name="alive" value="yes" />Yes &nbsp&nbsp   <input
				type="radio" name="alive" value="no" />No<br>
Gender:<input type="radio" name="gender" value="female" />Female &nbsp&nbsp   <input
				type="radio" name="gender" value="male" />Male &nbsp&nbsp  <input
				type="radio" name="gender" value="others" />Others<br>		
International:<input type="radio" name="international" value="yes" />Yes &nbsp&nbsp   <input
				type="radio" name="international" value="no" />No<br>
Married:<input type="radio" name="married" value="yes" />Yes &nbsp&nbsp   <input
				type="radio" name="married" value="no" />No<br>
